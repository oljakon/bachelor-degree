...
author_pos_3['author'] = labels
author_pos_3.to_csv('author_pos_3_30.csv', index=False)
...
author_pos_4.to_csv('author_pos_4_30.csv', index=False)
...
author_pos_5.to_csv('author_pos_5_30.csv', index=False)
